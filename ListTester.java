 ...
 * get you started.
 * 
 * @author mvail, mhthomas, awinters, Alex Taylor
 */
...
public class ListTester {
	...
	private void runTests() {
		...
		testEmptyList(A_removeA_emptyList, "A_removeA_emptyList");        //2
		testEmptyList(A_remove0_emptyList, "A_remove0_emptyList"); 			//10
		//1-element to empty list using Iterator
		testEmptyList(A_iterRemoveAfterNextA_emptyList, "A_iterRemoveAfterNextA_emptyList");    //15 (iterator)
		//empty to 1-element list
		testSingleElementList(emptyList_addToFrontA_A, "emptyList_addToFrontA_A", LIST_A, STRING_A);     //given
		testSingleElementList(emptyList_add0A_A, "emptyList_add0A_A", LIST_A, STRING_A);      //6
		testSingleElementList(emptyList_addToRearA_A, "emptyList_addToRearA_A", LIST_A, STRING_A);   //22
		//1-element to changed 1-element via set()
		testSingleElementList(A_set0B_B, "A_set0B_B", LIST_B, STRING_B);     //3
		//2-element to 1-element
		testSingleElementList(AB_remove0_B, "AB_remove0_B", LIST_B, STRING_B);      //4
		testSingleElementList(AB_removeFirst_B, "AB_removeFirst_B", LIST_B, STRING_B);       //8
		testSingleElementList(AB_removeLast_A, "AB_removeLast_A", LIST_A, STRING_A);    //9
		//2-element to 1-element using Iterator
		testSingleElementList(AB_iterRemoveA_B, "AB_iterRemoveA_B", LIST_B, STRING_B);             //16 (iterator)
		testSingleElementList(AB_iterRemoveB_A, "AB_iterRemoveB_A", LIST_A, STRING_A);    //17 (iterator)
		testSingleElementList(AB_iterRemoveAfterNextA_B, "AB_iterRemoveAfterNextA_B", LIST_B, STRING_B);    //21 (iterator)
		//1-element to 2-element
		testTwoElementList(A_addToFrontB_BA, "A_addToFrontB_BA", LIST_BA, STRING_BA);        //given
		testTwoElementList(A_addToRearB_AB, "A_addToRearB_AB", LIST_AB, STRING_AB);     //1
		testTwoElementList(A_addAfterBA_AB, "A_addAfterBA_AB", LIST_AB, STRING_AB);            //7
		//2-element to changed 2-element via set()
		testTwoElementList(AB_set1C_AC, "AB_set1C_AC", LIST_AC, STRING_AC);       //5
		//2-element to 3-element
		testThreeElementList(AB_addC_ABC, "AB_addC_ABC", LIST_ABC, STRING_ABC);    //11
		testThreeElementList(AB_addToFrontC_CAB, "AB_addToFrontC_CAB", LIST_CAB, STRING_CAB);    //12
		//3-element to 2-element
		testTwoElementList(ABC_removeA_BC, "ABC_removeA_BC", LIST_BC, STRING_BC);     //13
		//3-element to 2-element using Iterator
		testTwoElementList(ABC_iterRemoveA_BC, "ABC_iterRemoveA_BC", LIST_BC, STRING_BC);  //18 (iterator)
		testTwoElementList(ABC_iterRemoveB_AC, "ABC_iterRemoveB_AC", LIST_AC, STRING_AC);                   //19 (iterator)
		testTwoElementList(ABC_iterRemoveC_AB, "ABC_iterRemoveC_AB", LIST_AB, STRING_AB);   //20 (iterator)
		//3-element to changed 3-element via set()
		testThreeElementList(ABC_set2D_ABD, "ABC_set2D_ABD", LIST_ABD, STRING_ABD);   //14
		testThreeElementList(ABC_set0D_DBC, "ABC_set0D_DBC", LIST_DBC, STRING_DBC);               //23

		// LIST ITERATOR SCENARIOS TESTS //

		// testing remove after previous
		testEmptyList(A_iterRemoveAfterPrevious_emptyList, "A_iterRemoveAfterPrevious_emptyList"); 		//24 
		testSingleElementList(AB_iterRemoveAfterPrevious_B, "AB_iterRemoveAfterPrevious_B", LIST_B, STRING_B);   //25
		testSingleElementList(AB_iterRemoveAfterPrevious_A, "AB_iterRemoveAfterPrevious_A", LIST_A, STRING_A);  		//26
		testTwoElementList(ABC_iterRemoveAfterPrevious_BC, "ABC_iterRemoveAfterPrevious_BC", LIST_BC, STRING_BC); //27
		testTwoElementList(ABC_iterRemoveAfterPrevious_AC, "ABC_iterRemoveAfterPrevious_AC", LIST_AC, STRING_AC);     //28
		testTwoElementList(ABC_iterRemoveAfterPrevious_AB, "ABC_iterRemoveAfterPrevious_AB", LIST_AB, STRING_AB);			//29
		// testing add
		testSingleElementList(emptyList_iterAddA_A, "emptyList_iterAddA_A", LIST_A, STRING_A);	//30
		testTwoElementList(A_iterAddB_BA, "A_iterAddB_BA", LIST_BA, STRING_BA);	//31
		testTwoElementList(A_iterAddBAfterNext_AB, "A_iterAddBAfterNext_AB", LIST_AB, STRING_AB);	//32
		testTwoElementList(A_iterAddBAfterPrevious_BA, "A_iterAddBAfterPrevious_BA", LIST_BA, STRING_BA);  //33
		testThreeElementList(AB_iterAddC_CAB, "AB_iterAddC_CAB", LIST_CAB, STRING_CAB);	//34
		testThreeElementList(AB_iterAddCAfterNext_ACB, "AB_iterAddCAfterNext_ACB", LIST_ACB, STRING_ACB);	//35
		testThreeElementList(AB_iterAddCAfterNext_ABC, "AB_iterAddCAfterNext_ABC", LIST_ABC, STRING_ABC);		//36
		testThreeElementList(AB_iterAddCAfterPrevious_CAB, "AB_iterAddCAfterPrevious_CAB", LIST_CAB, STRING_CAB);	//37
		testThreeElementList(AB_iterAddCAfterPrevious_ACB, "AB_iterAddCAfterPrevious_ACB", LIST_ACB, STRING_ACB);		//38
		// testing set
		testSingleElementList(A_iterSetBAfterNext_B, "A_iterSetBAfterNext_B", LIST_B, STRING_B);	//39
		testSingleElementList(A_iterSetBAfterPrevious_B, "A_iterSetBAfterPrevious_B", LIST_B, STRING_B);	//40
		testTwoElementList(AB_iterSetCAfterNext_CB, "AB_iterSetCAfterNext_CB", LIST_CB, STRING_CB);	//41
		testTwoElementList(AB_iterSetCAfterNext_AC, "AB_iterSetCAfterNext_AC", LIST_AC, STRING_AC); 		 //42
		testTwoElementList(AB_iterSetCAfterPrevious_CB, "AB_iterSetCAfterPrevious_CB", LIST_CB, STRING_CB);	 //43
		testTwoElementList(AB_iterSetCAfterPrevious_AC, "AB_iterSetCAfterPrevious_AC", LIST_AC, STRING_AC);  		  //44
		testThreeElementList(ABC_iterSetDAfterNext_DBC, "ABC_iterSetDAfterNext_DBC", LIST_DBC, STRING_DBC);  //45
		testThreeElementList(ABC_iterSetDAfterNext_ADC, "ABC_iterSetDAfterNext_ADC", LIST_ADC, STRING_ADC);		//46
		testThreeElementList(ABC_iterSetDAfterNext_ABD, "ABC_iterSetDAfterNext_ABD", LIST_ABD, STRING_ABD);  //47
		testThreeElementList(ABC_iterSetDAfterPrevious_DBC, "ABC_iterSetDAfterPrevious_DBC", LIST_DBC, STRING_DBC);  //48
		testThreeElementList(ABC_iterSetDAfterPrevious_ADC, "ABC_iterSetDAfterPrevious_ADC", LIST_ADC, STRING_ADC);	   //49
		testThreeElementList(ABC_iterSetDAfterPrevious_ABD, "ABC_iterSetDAfterPrevious_ABD", LIST_ABD, STRING_ABD); //50
		// testing remove after next
		testEmptyList(A_iterRemoveAfterNext_emptyList, "A_iterRemoveAfterNext_emptyList"); //51
		testSingleElementList(AB_iterRemoveAfterNext_B, "AB_iterRemoveAfterNext_B", LIST_B, STRING_B);	//52
		testSingleElementList(AB_iterRemoveAfterNext_A, "AB_iterRemoveAfterNext_A", LIST_A, STRING_A);		 //53
		testTwoElementList(ABC_iterRemoveAfterNext_BC, "ABC_iterRemoveAfterNext_BC", LIST_BC, STRING_BC);		  //54
		testTwoElementList(ABC_iterRemoveAfterNext_AC, "ABC_iterRemoveAfterNext_AC", LIST_AC, STRING_AC);  //55
		testTwoElementList(ABC_iterRemoveAfterNext_AB, "ABC_iterRemoveAfterNext_AB", LIST_AB, STRING_AB);		 //56
	...
	/** Scenario [A,B] -> iteratorRemoveAfterNext -> [B]
	 * @return [B] after iteratorRemoveAfterNext
	 */
	...
	/** Scenario [A,B] -> iteratorRemoveA -> [B]
	 * @return [B] after iteratorRemoveA
	 */
	...
	/** Scenario [A,B] -> iteratorRemoveB -> [A]
	 * @return [A] after iteratorRemoveB
	 */
	...
	//Iter 2-element resulting Scenarios

	/** Scenario: [A,B,C] -> iterRemoveA -> [B,C]
	 * @return [B,C] after iterRemoveA
	 */
	...
	/** Scenario [A] -> iteratorRemoveAfterPrevious -> []
	...
	/** Scenario [A,B] -> iteratorRemoveAfterPrevious -> [B]
	...
	/** Scenario [A,B] -> iteratorRemoveAfterPrevious -> [A]
	 * @return [A] after iteratorRemoveAfterPrevous
	 */
	private IndexedUnsortedList<Integer> AB_iterRemoveAfterPrevious_A() {
		IndexedUnsortedList<Integer> list = A_addAfterBA_AB();
	...
	private Scenario<Integer> AB_iterRemoveAfterPrevious_A = () -> AB_iterRemoveAfterPrevious_A();

	/**	Scenario [A,B,C] -> iteratorRemoveAfterPrevious -> [B,C]
	...
	/**	Scenario [A,B,C] -> iteratorRemoveAfterPrevious -> [A,C]
	 * @return [A,C] after iteratorRemoveAfterPrevious
	 */
	private IndexedUnsortedList<Integer> ABC_iterRemoveAfterPrevious_AC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> listIt = list.listIterator(2);
		listIt.previous();
		listIt.remove();
	...
	private Scenario<Integer> ABC_iterRemoveAfterPrevious_AC = () -> ABC_iterRemoveAfterPrevious_AC();

	/**	Scenario [A,B,C] -> iteratorRemoveAfterPrevious -> [A,B]
	 * @return [A,B] after iteratorRemoveAfterPrevious
	 */
	private IndexedUnsortedList<Integer> ABC_iterRemoveAfterPrevious_AB() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
	...
	private Scenario<Integer> ABC_iterRemoveAfterPrevious_AB = () -> ABC_iterRemoveAfterPrevious_AB();

	/**	Scenario [] -> iteratorAddA -> [A]
	...
	/**	Scenario [A] -> iteratorAddB_AfterNext -> [A,B]
	 * @return [A,B] after iteratorAddB_AfterNext
	 */
	...
	/**	Scenario [A] -> iteratorAddB_AfterPrevious -> [B,A]
	 * @return [B,A] after iteratorAddB_AfterPrevious
	 */
	...
	/**	Scenario [A,B] -> iteratorAddC -> [C,A,B]
	 * @return [C,A,B] after iteratorAddC
	 */
	...
	/**	Scenario [A,B] -> iteratorAddC_AfterNext -> [A,C,B]
	 * @return [A,C,B] after iteratorAddC_AfterNext
	 */
	private IndexedUnsortedList<Integer> AB_iterAddCAfterNext_ACB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> listIt = list.listIterator();
		listIt.next();
		listIt.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterAddCAfterNext_ACB = () -> AB_iterAddCAfterNext_ACB();

	/**	Scenario [A,B] -> iteratorAddC_AfterNext -> [A,B,C]
	 * @return [A,B,C] after iteratorAddC_AfterNext
	 */
	private IndexedUnsortedList<Integer> AB_iterAddCAfterNext_ABC() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> listIt = list.listIterator(1);
		listIt.next();
		listIt.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterAddCAfterNext_ABC = () -> AB_iterAddCAfterNext_ABC();

	/**	Scenario [A,B] -> iteratorAddC_AfterPrevious -> [C,A,B]
	 * @return [C,A,B] after iteratorAddC_AfterPrevious
	 */
	private IndexedUnsortedList<Integer> AB_iterAddCAfterPrevious_CAB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> listIt = list.listIterator(1);
		listIt.previous();
		listIt.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterAddCAfterPrevious_CAB = () -> AB_iterAddCAfterPrevious_CAB();

	/**	Scenario [A,B] -> iteratorAddC_AfterPrevious -> [A,C,B]
	 * @return [A,C,B] after iteratorAddC_AfterPrevious
	 */
	private IndexedUnsortedList<Integer> AB_iterAddCAfterPrevious_ACB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> listIt = list.listIterator(2);
		listIt.previous();
		listIt.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterAddCAfterPrevious_ACB = () -> AB_iterAddCAfterPrevious_ACB();

	/**	Scenario [A] -> iteratorSetB_AfterNext -> [B]
	 * @return [B] after iteratorSetB_AfterNext
	 */
	private IndexedUnsortedList<Integer> A_iterSetBAfterNext_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		ListIterator<Integer> listIt = list.listIterator();
		listIt.next();
		listIt.set(ELEMENT_B);
		return list;
	}
	private Scenario<Integer> A_iterSetBAfterNext_B = () -> A_iterSetBAfterNext_B();

	/**	Scenario [A] -> iteratorSetB_AfterPrevious -> [B]
	 * @return [B] after iteratorSetB_AfterPrevious
	 */
	private IndexedUnsortedList<Integer> A_iterSetBAfterPrevious_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		ListIterator<Integer> listIt = list.listIterator(1);
		listIt.previous();
		listIt.set(ELEMENT_B);
	...
	private Scenario<Integer> A_iterSetBAfterPrevious_B = () -> A_iterSetBAfterPrevious_B();

	/**	Scenario [A,B] -> iteratorSetC_AfterNext -> [C,B]
	 * @return [C,B] after iteratorSetC_AfterNext
	 */
	private IndexedUnsortedList<Integer> AB_iterSetCAfterNext_CB() {
		IndexedUnsortedList<Integer> list = A_addAfterBA_AB();
		ListIterator<Integer> listIt = list.listIterator();
		listIt.next();
		listIt.set(ELEMENT_C);
		return list;
	}
	private Scenario<Integer> AB_iterSetCAfterNext_CB = () -> AB_iterSetCAfterNext_CB();

	/**	Scenario [A,B] -> iteratorSetC_AfterNext -> [A,C]
	 * @return [A,C] after iteratorSetC_AfterNext
	 */
	private IndexedUnsortedList<Integer> AB_iterSetCAfterNext_AC() {
		IndexedUnsortedList<Integer> list = A_addAfterBA_AB();
		ListIterator<Integer> listIt = list.listIterator(1);
		listIt.next();
		listIt.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterSetCAfterNext_AC = () -> AB_iterSetCAfterNext_AC();

	/**	Scenario [A,B] -> iteratorSetC_AfterPrevious -> [C,B]
	 * @return [C,B] after iteratorSetC_AfterPrevious
	 */
	private IndexedUnsortedList<Integer> AB_iterSetCAfterPrevious_CB() {
		IndexedUnsortedList<Integer> list = A_addAfterBA_AB();
		ListIterator<Integer> listIt = list.listIterator(1);
		listIt.previous();
		listIt.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterSetCAfterPrevious_CB = () -> AB_iterSetCAfterPrevious_CB();

	/**	Scenario [A,B] -> iteratorSetC_AfterPrevious -> [A,C]
	 * @return [A,C] after iteratorSetC_AfterPrevious
	 */
	private IndexedUnsortedList<Integer> AB_iterSetCAfterPrevious_AC() {
		IndexedUnsortedList<Integer> list = A_addAfterBA_AB();
		ListIterator<Integer> listIt = list.listIterator(2);
		listIt.previous();
		listIt.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterSetCAfterPrevious_AC = () -> AB_iterSetCAfterPrevious_AC();

	/**	Scenario [A,B,C] -> iteratorSetD_AfterNext -> [D,B,C]
	 * @return [D,B,C] after iteratorSetD_AfterNext
	 */
	private IndexedUnsortedList<Integer> ABC_iterSetDAfterNext_DBC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> listIt = list.listIterator();
		listIt.next();
		listIt.set(ELEMENT_D);
		return list;
	}
	private Scenario<Integer> ABC_iterSetDAfterNext_DBC = () -> ABC_iterSetDAfterNext_DBC();

	/**	Scenario [A,B,C] -> iteratorSetD_AfterNext -> [A,D,C]
	 * @return [A,D,C] after iteratorSetD_AfterNext
	 */
	private IndexedUnsortedList<Integer> ABC_iterSetDAfterNext_ADC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> listIt = list.listIterator(1);
		listIt.next();
		listIt.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_iterSetDAfterNext_ADC = () -> ABC_iterSetDAfterNext_ADC();

	/**	Scenario [A,B,C] -> iteratorSetD_AfterNext -> [A,B,D]
	 * @return [A,B,D] after iteratorSetD_AfterNext
	 */
	private IndexedUnsortedList<Integer> ABC_iterSetDAfterNext_ABD() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> listIt = list.listIterator(2);
		listIt.next();
		listIt.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_iterSetDAfterNext_ABD = () -> ABC_iterSetDAfterNext_ABD();

	/**	Scenario [A,B,C] -> iteratorSetD_AfterPrevious -> [D,B,C]
	 * @return [D,B,C] after iteratorSetD_AfterPrevious
	 */
	...
	/**	Scenario [A,B,C] -> iteratorSetD_AfterPrevious -> [A,D,C]
	 * @return [A,D,C] after iteratorSetD_AfterPrevious
	 */
	private IndexedUnsortedList<Integer> ABC_iterSetDAfterPrevious_ADC() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> listIt = list.listIterator(2);
		listIt.previous();
		listIt.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_iterSetDAfterPrevious_ADC = () -> ABC_iterSetDAfterPrevious_ADC();

	/**	Scenario [A,B,C] -> iteratorSetD_AfterPrevious -> [A,B,D]
	 * @return [A,B,D] after iteratorSetD_AfterPrevious
	 */
	private IndexedUnsortedList<Integer> ABC_iterSetDAfterPrevious_ABD() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> listIt = list.listIterator(3);
		listIt.previous();
		listIt.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_iterSetDAfterPrevious_ABD = () -> ABC_iterSetDAfterPrevious_ABD();
	...
	/**	Scenario [A,B] -> iteratorRemoveAfterNext -> [A]
	 * @return [A] after iteratorRemoveAfterNext
	 */
	private IndexedUnsortedList<Integer> AB_iterRemoveAfterNext_A() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> listIt = list.listIterator(1);
		listIt.next();
		listIt.remove();
	...
	private Scenario<Integer> AB_iterRemoveAfterNext_A = () -> AB_iterRemoveAfterNext_A();

	/**	Scenario [A,B,C] -> iteratorRemoveAfterNext -> [B,C]
	 * @return [B,C] after iteratorRemoveAfterNext
	 */
	...
	/**	Scenario [A,B,C] -> iteratorRemoveAfterNext -> [A,C]
	 * @return [A,C] after iteratorRemoveAfterNext
	 */
	...
	/**	Scenario [A,B,C] -> iteratorRemoveAfterNext -> [A,B]
	 * @return [A,B] after iteratorRemoveAfterNext
	 */
	private IndexedUnsortedList<Integer> ABC_iterRemoveAfterNext_AB() {
		IndexedUnsortedList<Integer> list = AB_addC_ABC();
		ListIterator<Integer> listIt = list.listIterator(2);
		listIt.next();
		listIt.remove();
	...
	private Scenario<Integer> ABC_iterRemoveAfterNext_AB = () -> ABC_iterRemoveAfterNext_AB();

	/**	Scenario [A,B] -> remove1_A_iterNext_testIterHasNext()
	 * @return [A] after remove1_A_iterNext
	 */
	private IndexedUnsortedList<Integer> AB_remove1_iterNext_A () {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		//ListIterator<Integer> listIt = list.listIterator();
		list.remove(1);
		return list;
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testAddAtIndex0", testAddAtIndex(scenario.build(), 0, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAtIndex1", testAddAtIndex(scenario.build(), 1, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAtIndex1", testAddAtIndex(scenario.build(), 2, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAtIndex2", testAddAtIndex(scenario.build(), 3, ELEMENT_X, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testSetNeg1", testSet(scenario.build(), -1, ELEMENT_X, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testSet0", testSet(scenario.build(), 0, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testSet0", testSet(scenario.build(), 1, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testSet1", testSet(scenario.build(), 2, ELEMENT_X, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testAdd", testAdd(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testGetNeg1", testGet(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testGet0", testGet(scenario.build(), 0, contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testGet0", testGet(scenario.build(), 1, contents[1], Result.MatchingValue));
			...
			// Added Iterator Tests (16 tests: 15 + 1 testIter)
			printTest(scenarioName + "_testIter", testIter(scenario.build(), Result.NoException));
			printTest(scenarioName + "_testIterHasNext", testIterHasNext(scenario.build().iterator(), Result.True));
			printTest(scenarioName + "_testIterNext", testIterNext(scenario.build().iterator(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testIterRemove", testIterRemove(scenario.build().iterator(), Result.IllegalState));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testAddAtIndex1", testAddAtIndex(scenario.build(), 1, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAtIndex1", testAddAtIndex(scenario.build(), 2, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAtIndex1", testAddAtIndex(scenario.build(), 3, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAtIndex2", testAddAtIndex(scenario.build(), 4, ELEMENT_X, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testSetNeg1", testSet(scenario.build(), -1, ELEMENT_X, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testSet0", testSet(scenario.build(), 0, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testSet0", testSet(scenario.build(), 1, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testSet0", testSet(scenario.build(), 2, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testSet1", testSet(scenario.build(), 3, ELEMENT_X, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testAdd", testAdd(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testGetNeg1", testGet(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testGet0", testGet(scenario.build(), 0, contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testGet0", testGet(scenario.build(), 1, contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testGet0", testGet(scenario.build(), 2, contents[2], Result.MatchingValue));
			printTest(scenarioName + "_testGet1", testGet(scenario.build(), 3, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testIndexOf" + contentsString.charAt(0), testIndexOf(scenario.build(), contents[0], 0));
			printTest(scenarioName + "_testIndexOf" + contentsString.charAt(1), testIndexOf(scenario.build(), contents[1], 1));
			...
			printTest(scenarioName + "_testRemove0", testRemoveIndex(scenario.build(), 0, contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemove0", testRemoveIndex(scenario.build(), 1, contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testRemove0", testRemoveIndex(scenario.build(), 2, contents[2], Result.MatchingValue));
			printTest(scenarioName + "_testRemove1", testRemoveIndex(scenario.build(), 3, null, Result.IndexOutOfBounds));
			// Added Iterator Tests (22 tests: 21 + 1 testIter)
			printTest(scenarioName + "_testIter", testIter(scenario.build(), Result.NoException));
			printTest(scenarioName + "_testIterHasNext", testIterHasNext(scenario.build().iterator(), Result.True));
			printTest(scenarioName + "_testIterNext", testIterNext(scenario.build().iterator(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testIterRemove", testIterRemove(scenario.build().iterator(), Result.IllegalState));
